...
final class Status
{
    ...
    private const MAP = [
        ...
        'notification' => [
            ...
            'checklist_missed'  => ['Check not finished',  'warn',   'clock'],
        ...
        'role' => [
            ...
            'staff'      => ['Staff',               'info',   'clipboard-check'],
        ],
        'check' => [
            'done'        => ['Done',          'ok',     'check-circle'],
            'late'        => ['Done late',     'warn',   'clock'],
            'in_progress' => ['In progress',   'info',   'edit'],
            'due'         => ['Due',           'muted',  'clock'],
            'overdue'     => ['Not finished',  'danger', 'alert-triangle'],
            'missed'      => ['Missed',        'danger', 'x'],
            'anytime'     => ['Any time today', 'muted', 'calendar'],
        ],
        'entity' => [
