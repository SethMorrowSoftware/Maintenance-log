...
--  Machines screen. The indoor extras at the end were guesses; trim or add.
--
...
VALUES
  ...
  (33, 'BL-009', 'Bowling Lane 9', 13, 14, 'in_service', 'medium',
   'Electric', NULL, 'cycles', 0.00, 'Lane, pinsetter, ball return and scoring for this lane. Weekly lane check; monthly pinsetter service.', 'qm6cgpsa4rt5wg0x7', 490, 1),
  (34, 'BL-010', 'Bowling Lane 10', 13, 14, 'in_service', 'medium',
   'Electric', NULL, 'cycles', 0.00, 'Lane, pinsetter, ball return and scoring for this lane. Weekly lane check; monthly pinsetter service.', 'qewcu572l8bxsyqaf', 500, 1),
  (35, 'BL-011', 'Bowling Lane 11', 13, 14, 'in_service', 'medium',
   'Electric', NULL, 'cycles', 0.00, 'Lane, pinsetter, ball return and scoring for this lane. Weekly lane check; monthly pinsetter service.', 'qgip7pr209x4g5hrb', 510, 1),
  (36, 'BL-012', 'Bowling Lane 12', 13, 14, 'in_service', 'medium',
   'Electric', NULL, 'cycles', 0.00, 'Lane, pinsetter, ball return and scoring for this lane. Weekly lane check; monthly pinsetter service.', 'qup6eog1n63pd3hng', 520, 1),
  (37, 'AX-001', 'Axe Throw Unit 1', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'q0cw431uqqmqghshn', 510, 1),
  (38, 'AX-002', 'Axe Throw Unit 2', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'qps9hltc7vdkvpey4', 520, 1),
  (39, 'AX-003', 'Axe Throw Unit 3', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'qdu2wvkf6c6f6vi3x', 530, 1),
  (40, 'AX-004', 'Axe Throw Unit 4', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'q1irmylpex8l2hsjt', 540, 1),
  (41, 'AX-005', 'Axe Throw Unit 5', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'qffxogeabx4gysgni', 550, 1),
  (42, 'AX-006', 'Axe Throw Unit 6', 14, 15, 'in_service', 'medium',
   '', 2, 'none', 0.00, 'Throwing lane: target boards, backstop, cage and the axes kept at the lane. Daily lane check.', 'qxksfoheqgf0uh7rl', 560, 1),
  (43, 'LT-001', 'Laser Tag Arena', 9, 8, 'in_service', 'medium',
   'Electric', NULL, 'none', 0.00, 'Arena, vests, phasers and effects.', 'qiqvbb24lhkw5qium', 600, 1),
  (44, 'RR-001', 'Roller Rink', 15, 16, 'in_service', 'medium',
   'Electric', NULL, 'none', 0.00, 'Skating floor, barriers, lighting and the rental skate fleet.', 'q8svqzzryfoxrpv9g', 610, 1),
  (45, 'CW-001', 'Climbing Wall', 15, 17, 'in_service', 'high',
   '', NULL, 'none', 0.00, 'Climbing wall with auto-belay devices. Daily check of belays, harnesses and mats; annual belay recertification.', 'qdqzkd01i715hqh5q', 620, 1),
  (46, 'MG-001', 'Mini Golf Course', 7, 6, 'in_service', 'low',
   '', NULL, 'none', 0.00, 'Course holes, obstacles, water features and pumps.', 'q1mpc9k3khli4z4la', 630, 1),
  (47, 'AR-001', 'Arcade', 6, 4, 'in_service', 'low',
   'Electric', NULL, 'none', 0.00, 'Arcade floor and game cabinets. Add individual cabinets as their own machines if you want to track them separately.', 'q5t82y2hxg11o92nd', 640, 1),
  (48, 'FE-001', 'Shop Air Compressor', 11, 9, 'in_service', 'medium',
   'Electric', NULL, 'hours', 0.00, 'Workshop compressor. Quarterly service: drain, filter, belt, safety valve.', 'qmq2v8rkjcqz600xz', 700, 1);
...
VALUES
  ...
  (39, 32, 'Lane 8 — monthly pinsetter service', 'Lubrication, belts, chains, adjustments and a clean-out per the pinsetter manual.', 'preventive', 5, 'monthly', 1,
   NULL, 5, 1.00, 'normal', 'Lock out the machine first. Clean and lubricate per the manual. Check belts, chains and springs. Adjust the deck and the pin table. Cycle under observation before releasing the lane.', 1, 1),
  (40, 33, 'Lane 9 — monthly pinsetter service', 'Lubrication, belts, chains, adjustments and a clean-out per the pinsetter manual.', 'preventive', 5, 'monthly', 1,
   NULL, 5, 1.00, 'normal', 'Lock out the machine first. Clean and lubricate per the manual. Check belts, chains and springs. Adjust the deck and the pin table. Cycle under observation before releasing the lane.', 1, 1),
  (41, 34, 'Lane 10 — monthly pinsetter service', 'Lubrication, belts, chains, adjustments and a clean-out per the pinsetter manual.', 'preventive', 5, 'monthly', 1,
   NULL, 5, 1.00, 'normal', 'Lock out the machine first. Clean and lubricate per the manual. Check belts, chains and springs. Adjust the deck and the pin table. Cycle under observation before releasing the lane.', 1, 1),
  (42, 35, 'Lane 11 — monthly pinsetter service', 'Lubrication, belts, chains, adjustments and a clean-out per the pinsetter manual.', 'preventive', 5, 'monthly', 1,
   NULL, 5, 1.00, 'normal', 'Lock out the machine first. Clean and lubricate per the manual. Check belts, chains and springs. Adjust the deck and the pin table. Cycle under observation before releasing the lane.', 1, 1),
  (43, 36, 'Lane 12 — monthly pinsetter service', 'Lubrication, belts, chains, adjustments and a clean-out per the pinsetter manual.', 'preventive', 5, 'monthly', 1,
   NULL, 5, 1.00, 'normal', 'Lock out the machine first. Clean and lubricate per the manual. Check belts, chains and springs. Adjust the deck and the pin table. Cycle under observation before releasing the lane.', 1, 1),
  (44, 37, 'Axe Throw Unit 1 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
  ...
  (45, 38, 'Axe Throw Unit 2 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
   NULL, 5, 0.50, 'normal', 'Replace any board that is soft, split or rejecting axes. Check every fastener on the cage and backstop. Sharpen or retire axes; replace cracked handles.', 1, 1),
  (46, 39, 'Axe Throw Unit 3 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
   NULL, 5, 0.50, 'normal', 'Replace any board that is soft, split or rejecting axes. Check every fastener on the cage and backstop. Sharpen or retire axes; replace cracked handles.', 1, 1),
  (47, 40, 'Axe Throw Unit 4 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
   NULL, 5, 0.50, 'normal', 'Replace any board that is soft, split or rejecting axes. Check every fastener on the cage and backstop. Sharpen or retire axes; replace cracked handles.', 1, 1),
  (48, 41, 'Axe Throw Unit 5 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
   NULL, 5, 0.50, 'normal', 'Replace any board that is soft, split or rejecting axes. Check every fastener on the cage and backstop. Sharpen or retire axes; replace cracked handles.', 1, 1),
  (49, 42, 'Axe Throw Unit 6 — monthly target and cage service', 'Rotate or replace target boards, tighten the cage and backstop, service the axes.', 'preventive', 4, 'monthly', 1,
   NULL, 5, 0.50, 'normal', 'Replace any board that is soft, split or rejecting axes. Check every fastener on the cage and backstop. Sharpen or retire axes; replace cracked handles.', 1, 1),
  (50, 45, 'Climbing Wall — annual auto-belay recertification', 'Auto-belay devices returned to the manufacturer or an approved service centre for annual recertification.', 'inspection', NULL, 'annual', 1,
  ...
  (51, 45, 'Climbing Wall — monthly holds and anchor check', 'Tighten holds, inspect t-nuts, anchors and top-out hardware.', 'preventive', 6, 'monthly', 1,
   NULL, 5, 1.50, 'normal', 'Check every hold for spinning. Inspect anchors and auto-belay mounts. Replace worn mats.', 1, 1),
  (52, 43, 'Laser Tag — quarterly vest and phaser service', 'Battery health, straps, sensors and phaser function across the whole set.', 'preventive', NULL, 'quarterly', 1,
  ...
  (53, 44, 'Roller Rink — monthly floor and skate fleet check', 'Floor surface, barriers, lighting and the rental skates.', 'preventive', NULL, 'monthly', 1,
  ...
  (54, 46, 'Mini Golf — pre-season course walk', 'Every hole, obstacle, water feature and pump before opening for the season.', 'preventive', NULL, 'annual', 1,
  ...
  (55, 48, 'Compressor — quarterly service', 'Drain, filters, belt, safety valve and pressure switch.', 'preventive', NULL, 'quarterly', 1,
